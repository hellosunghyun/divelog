/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e374fc3e02ebbe0471c3eeebc22cc6f7)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		TEST_ADMIN_SESSION: string;
		TEST_VERIFIED_SESSION: string;
		TEST_UNVERIFIED_SESSION: string;
	}
}
