    ...
    learnerSentences: [
      {
        sentence: {
          ...
          content: "남겨둔 문장",
          reason: null,
          learnerName: fixture.learner.displayName,
          learnerSlug: fixture.learner.slug,
          sourceRecordTitle: "첫 번째 기록",
          sourceRecordSlug: "first-record",
          savedAt: now,
        },
      },
    ],
