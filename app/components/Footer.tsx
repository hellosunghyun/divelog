        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          <div className="lg:col-span-5">
            ...
            <p className="text-mist-blue/60 text-[15px] leading-relaxed max-w-sm">
              성찰적 아카이빙과 깊은 탐구를 위한 협력적 공간입니다. 조용한 깊이를 지향하는 마음으로 운영됩니다.
            </p>
          </div>

          <div className="lg:col-span-3">
            <h4 className="text-[11px] font-semibold uppercase tracking-[0.2em] text-mist-blue/40 mb-5">탐색</h4>
          ...
          <div className="lg:col-span-3">
            <h4 className="text-[11px] font-semibold uppercase tracking-[0.2em] text-mist-blue/40 mb-5">커뮤니티</h4>
            <nav className="flex flex-col gap-3">
